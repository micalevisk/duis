 ...
 */
__(function getDeepValue(obj, path) {
  return  path.reduce(
...
/**
 * Remove o separador excedente de um caminho do sistema de arquivos,
 * gerado pelo auto-complete. Independente do separador.
 * Utiliza a biblioteca `path`.
 * @example
 * trimPathSeparator('foo/bar/') // 'foo/bar'
 * @param {string} pathName
 * @returns {string}
 */
__(function trimPathSeparator(pathName) {
